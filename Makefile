...
C_FILE		 =	main.cpp srcs/Server.cpp srcs/Client.cpp srcs/Channel.cpp srcs/Command/Join.cpp srcs/Command/Part.cpp srcs/Command/Mode.cpp srcs/Command/Kick.cpp srcs/Command/Invit.cpp
